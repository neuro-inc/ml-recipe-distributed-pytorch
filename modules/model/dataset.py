...
if __name__ == '__main__':
    ...
    data_preprocessor = RawDataPreprocessor(in_path='./data/simplified-nq-train.jsonl',
                                            out_path='./data/simplified-nq-train_preprocessed.jsonl',
                                            tokenizer=tokenizer)

    data_preprocessor()

    data_extractor = LineDataExtractor(data_path='./data/simplified-nq-train_preprocessed.jsonl')
    for line in data_extractor:
        print(DatasetItem(**line))
        break
